...
<section class="content">
	<div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{url('/kelas/store')}}" method="POST">
            	{{csrf_field()}}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="kompetensi_keahlian" id="kompetensi_keahlian" placeholder="Kompetensi Keahlian">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
